...
This library is a shameless fork from James Henderson's excellent library `https://github.com/james-henderson/chime`, the only change is in-millis is reverted to in-msecs to reflect the clj-time<'0.5.0' used in Storm.
...
#+BEGIN_SRC clojure
  [neone4373/chime "0.1.5-for-storm"]
#+END_SRC
